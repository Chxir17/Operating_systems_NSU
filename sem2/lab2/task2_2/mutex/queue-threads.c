//Мьютекс (mutex) — это механизм синхронизации, который гарантирует взаимное исключение:
//в каждый момент времени критическую секцию кода может выполнять только один поток.
